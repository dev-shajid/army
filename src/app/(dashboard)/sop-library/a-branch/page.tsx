...
const subFolders = [
  { title: "Officer", href: "/sop-library/a-branch/officer", description: "Officer-level SOPs" },
  { title: "JSO", href: "/sop-library/a-branch/jso", description: "Junior Staff Officer SOPs" },
  { title: "OR", href: "/sop-library/a-branch/or", description: "Other Ranks SOPs" },
]
